...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discounntPrice) return setError('Discount price must be lower than regular price')
            setLoading(true);
            setError(false);
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    {formData.offer && (
                        <div className="flex items-center gap-2">
                        <input type="number" id='discountPrice' min='0' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formData.discounntPrice} />
                        <div className="flex flex-col items-center">
